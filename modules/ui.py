...
QSS = """
QMainWindow, QDialog { background-color: #0F172A; color: #F8FAFC; }
QWidget { color: #F8FAFC; font-family: "Segoe UI", "SF Pro Display", "Inter", Arial, sans-serif; font-size: 11pt; }
...
QPushButton:hover  { background-color: #475569; border: 1px solid #94A3B8; }
...
/* Bắt mắt, nổi bật các nút quan trọng */
QPushButton#primaryAction {
    background-color: qlineargradient(x1: 0, y1: 0, x2: 1, y2: 1, stop: 0 #8B5CF6, stop: 0.5 #D946EF, stop: 1 #F43F5E);
    color: white;
    border: none;
    border-radius: 10px;
    padding: 12px 24px;
...
QPushButton#primaryAction:hover { 
    background-color: qlineargradient(x1: 0, y1: 0, x2: 1, y2: 1, stop: 0 #A78BFA, stop: 0.5 #E879F9, stop: 1 #FB7185);
}
